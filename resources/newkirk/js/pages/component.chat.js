/*
* Theme: NewKirk - Responsive Bootstrap 5 Admin Dashboard
* Author: Coderthemes
...
!function ($) {
    ...
    ChatApp.prototype.save = function () {
        var chNewKirkt = this.$chatInput.val();
        var chatTime = moment().format("h:mm");
        if (chNewKirkt == "") {
            this.$chatInput.focus();
            return false;
        } else {
            $('<li class="clearfix odd"><div class="chat-avatar"><img src="/images/users/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Dominic</i><p>' + chNewKirkt + '</p></div></div></li>').appendTo('.conversation-list');
            this.$chatInput.focus();
