...
function sliderPreview() {
    return {
        title: '{{ old('title', 'Luxury Scent Collection') }}',
        subtitle: '{{ old('subtitle', 'New Arrivals 2026') }}',
        description: '{{ old('description', 'Enter the descriptive text that appears on the slide...') }}',
        button_text: '{{ old('button_text', 'Shop Now') }}',
        bg_color: '{{ old('bg_color', '#FDFCF8') }}',
        accent_color: '{{ old('accent_color', '#D4AF37') }}',
        ui_theme: '{{ old('ui_theme', 'dark') }}',
        social_color: '{{ old('social_color', '#111827') }}',
        social_hover_color: '{{ old('social_hover_color', '#D4AF37') }}',
        social_icon_color: '{{ old('social_icon_color', '#FFFFFF') }}',
        social_icon_hover_color: '{{ old('social_icon_hover_color', '#111827') }}',
        nav_color: '{{ old('nav_color', '#111827') }}',
        nav_hover_color: '{{ old('nav_hover_color', '#D4AF37') }}',
        nav_icon_color: '{{ old('nav_icon_color', '#FFFFFF') }}',
        nav_icon_hover_color: '{{ old('nav_icon_hover_color', '#111827') }}',
        line_color: '{{ old('line_color', '#D4AF37') }}',
        title_color: '{{ old('title_color', '#111827') }}',
        description_color: '{{ old('description_color', '#6B7280') }}',
        price_color: '{{ old('price_color', '#111827') }}',
        price: '{{ old('price') }}',
        top_notes: '{{ old('top_notes') }}',
        imagePreview: null,
