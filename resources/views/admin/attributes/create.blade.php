...
<div class="max-w-2xl">
    <div class="flex items-center gap-4 mb-10">
        ...
        <h3 class="font-serif text-xl">New Attribute</h3>
    </div>

    <div class="bg-white border border-black/5 p-10">
        <form action="{{ route('admin.attributes.store') }}" method="POST" class="space-y-8">
            @csrf
            <div>
                <label class="block text-[10px] uppercase tracking-widest mb-3 opacity-60">Attribute Name (e.g., Color, Size)</label>
            ...
            <div>
                ...
                <div id="values-container" class="space-y-4">
                    <div class="flex items-center gap-4">
                        <input type="text" name="values[]" required placeholder="Value (e.g., XL or Black)"
                        ...
                        <button type="button" class="w-10 h-10 flex items-center justify-center text-red-300 opacity-0 cursor-default"><i class="ri-delete-bin-line"></i></button>
                    </div>
                </div>
