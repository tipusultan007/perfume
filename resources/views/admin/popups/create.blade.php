...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Create New Popup</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-12">
            ...
            <form id="popup-form" action="{{ route('admin.popups.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <label class="form-label text-uppercase fs-11 fw-bold text-muted">Popup Image (Required)</label>
                            <div class="p-4 border-2 border-dashed rounded text-center bg-light position-relative hover-bg-light transition-all">
                                <input type="file" name="image" required class="position-absolute w-100 h-100 top-0 start-0 opacity-0 cursor-pointer" style="z-index: 10;" accept="image/*">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Summer Sale" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-uppercase fs-11 fw-bold text-muted">Subtitle</label>
                                <input type="text" name="subtitle" value="{{ old('subtitle') }}" placeholder="e.g. 50% Off Everything" class="form-control">
                            </div>
                            <div class="col-12">
                                <label class="form-label text-uppercase fs-11 fw-bold text-muted">Description</label>
                                <textarea name="description" rows="3" placeholder="Enter popup description..." class="form-control">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-1">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="link" value="{{ old('link') }}" placeholder="https://..." class="form-control font-monospace fs-12">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-uppercase fs-11 fw-bold text-muted">CTA Text</label>
                                <input type="text" name="cta_text" value="{{ old('cta_text') }}" placeholder="e.g. Shop Now" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="start_date" value="{{ old('start_date') }}" class="form-control font-monospace fs-12">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-uppercase fs-11 fw-bold text-muted">End Date & Time</label>
                                <input type="datetime-local" name="end_date" value="{{ old('end_date') }}" class="form-control font-monospace fs-12">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 border rounded bg-light">
                                    <div class="form-check form-switch d-flex justify-content-between align-items-center ps-0">
                                        ...
                                        <input class="form-check-input ms-0" type="checkbox" name="show_newsletter" id="show_newsletter" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="mb-5 d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg flex-grow-1 py-3 fw-bold text-uppercase tracking-widest fs-12 shadow-lg">
                        <i class="ri-save-line me-1"></i> Create Popup Configuration
                    </button>
                </div>
            </form>
        </div>
