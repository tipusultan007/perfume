...
<div class="max-w-4xl">
    ...
    <div class="bg-white border border-slate-200 p-8 md:p-12 rounded-2xl shadow-sm overflow-hidden">
        <form action="{{ route('admin.popups.update', $popup) }}" method="POST" enctype="multipart/form-data" class="space-y-10">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $popup->title) }}" placeholder="e.g. Summer Sale 50% Off"
