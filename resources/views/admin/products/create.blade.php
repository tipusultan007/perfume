    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2 space-y-10">
            <div class="bg-white border border-black/5 p-10">
                <h3 class="font-serif text-xl mb-8 border-b border-black/5 pb-4">General Information</h3>
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" rows="3" class="w-full p-4 border border-black/10 focus:border-luxury-black outline-none transition-colors text-sm bg-transparent">{{ old('short_description') }}</textarea>
                    </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <textarea name="top_notes" rows="2" placeholder="Citrus, Bergamot..." class="w-full p-3 border border-black/10 focus:border-luxury-black outline-none transition-colors text-sm bg-transparent">{{ old('top_notes') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase tracking-widest mb-3 opacity-60">Heart Notes</label>
                            <textarea name="heart_notes" rows="2" placeholder="Rose, Jasmine..." class="w-full p-3 border border-black/10 focus:border-luxury-black outline-none transition-colors text-sm bg-transparent">{{ old('heart_notes') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase tracking-widest mb-3 opacity-60">Base Notes</label>
                            <textarea name="base_notes" rows="2" placeholder="Musk, Amber..." class="w-full p-3 border border-black/10 focus:border-luxury-black outline-none transition-colors text-sm bg-transparent">{{ old('base_notes') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-black/5 p-10">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="3" class="w-full p-4 border border-black/10 focus:border-luxury-black outline-none transition-colors text-sm bg-transparent text-xs">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-black/5 p-10">
                <div class="flex justify-between items-center mb-8 border-b border-black/5 pb-4">
                    ...
                    <select name="product_type" id="product_type" onchange="toggleVariantSection()" 
                        class="text-[10px] uppercase tracking-widest font-semibold border-none bg-luxury-cream px-4 py-2 rounded focus:ring-0">
                ...
                <div id="variable-setup" class="hidden space-y-10">
                    <div class="bg-gray-50/50 p-6 border border-black/5">
                        <h4 class="text-[10px] uppercase tracking-widest mb-6 font-semibold opacity-60 text-center">Step 1: Select Attributes</h4>
                        <div class="space-y-6">
                        ...
                        <button type="button" onclick="generateVariants()" class="w-full mt-10 py-4 border border-luxury-black text-luxury-black text-[10px] uppercase tracking-widest hover:bg-luxury-black hover:text-white transition-all">
                            Generate All Combinations
                        </button>
                    </div>

                    <div id="variants-table-container" class="hidden">
                        <h4 class="text-[10px] uppercase tracking-widest mb-6 font-semibold opacity-60 text-center">Step 2: Configure Variants</h4>
                        <div class="overflow-x-auto">
                            <table class="w-full text-left">
                                ...
                                <tbody id="variants-tbody" class="text-xs">
                                </tbody>
                            </table>
                        </div>
                    </div>
                ...
                <div id="bundle-setup" class="hidden space-y-10">
                   <div class="bg-gray-50/50 p-6 border border-black/5">
                        <h4 class="text-[10px] uppercase tracking-widest mb-6 font-semibold opacity-60 text-center">Select Products for Bundle</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                            ...
                            <label class="flex items-center space-x-3 p-4 bg-white border border-black/5 hover:border-black/20 cursor-pointer transition-all">
                                <input type="checkbox" name="bundle_items[]" value="{{ $sProduct->id }}" class="form-checkbox h-4 w-4 text-luxury-black border-gray-300 focus:ring-0">
                                <div>
        ...
        <div class="space-y-10">
            ...
            <div class="bg-white border border-black/5 p-8">
                ...
                <div onclick="document.getElementById('primary_image').click()" 
                    ...
                    <div id="primary-preview" class="hidden absolute inset-0 bg-white">
            ...
            <div class="bg-white border border-black/5 p-8">
                ...
                <div class="preview-container mb-6" id="gallery-preview"></div>
...
<script>
    ...
    function generateVariants() {
        ...
        combinations.forEach((combo, index) => {
            ...
            row.className = 'border-b border-black/5 hover:bg-gray-50/50 transition-all';
            row.innerHTML = `
                <td class="py-6 pr-4">
                ...
                <td class="text-right">
                    <button type="button" onclick="this.closest('tr').remove()" class="text-red-300 hover:text-red-500 transition-colors"><i class="ri-close-line text-lg"></i></button>
                </td>
            `;
